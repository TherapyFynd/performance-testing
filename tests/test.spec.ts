...
test('test', async ({ page }) => {
  await page.goto('https://enterprise-e8038.firebaseapp.com/__/auth/action?apiKey=AIzaSyD9w7OjQ1mbRxWX-kqUelVtwpnrxAhkpaA&mode=signIn&oobCode=OzyGnG-2DEL5YhwlWzb0GGDt1bhnIQp90kYs-VluU8MAAAGPmcthiw&continueUrl=https://leafs-ehr-web-stage-nmvorvf7ga-as.a.run.app/auth/passwordless?email%3Dz7knk.bqyev@inbox.testmail.app&lang=en');
