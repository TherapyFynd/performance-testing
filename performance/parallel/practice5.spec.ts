...
const responseLogsFile = path.join(logsDir, 'practice5-responses.txt');
...
// Main test cases
test.describe('All Practice5 Role Test Cases', () => {
  test('Practice5 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Practice 5";
  ...
  }, "Practice 5 Navigate to login page", rolePrefix);
