...
const responseLogsFile = path.join(logsDir, 'therapist4-responses.txt');
...
// Main test cases
test.describe('All Therapist4 Role Test Cases', () => {
  test('Therapist4 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Therapist 4";
    ...
    }, "Therapist 4 Navigate to login page", rolePrefix);
