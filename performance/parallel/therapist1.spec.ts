...
test('Therapist1 login and  onboarding ', async ({ request }) => {
  ...
  await page.waitForLoadState('load');}, "Therapist 1 Navigate to login page");
...
// Appoinment 9
    ...
    await page.getByLabel('After').fill('5'); } ," Recurring Appoinments" );
...
// Appoinment 12
    ...
    await page.getByLabel('Span').click();
    await page.getByRole('option', { name: 'days' }).click(); }, "Recurring Appoinment");
