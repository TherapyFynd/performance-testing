...
const responseLogsFile = path.join(logsDir, 'practice4-responses.txt');
...
// Main test cases
test.describe('All Practice4 Role Test Cases', () => {
  test('Practice4 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Practice 4";
