...
const responseLogsFile = path.join(logsDir, 'supervisor2-responses.txt');
...
// Main test cases
test.describe('All Supervisor2 Role Test Cases', () => {
  test('Supervisor2 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Supervisor 2";
    ...
    }, "Supervisor 2 Navigate to login page", rolePrefix);
