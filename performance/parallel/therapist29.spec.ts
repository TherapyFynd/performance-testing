...
const responseLogsFile = path.join(logsDir, 'therapist29-responses.txt');
...
// Main test cases
test.describe('All Therapist29 Role Test Cases', () => {
  test('Therapist29 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Therapist 29";
    ...
    }, "Therapist 29 Navigate to login page", rolePrefix);
