...
const responseLogsFile = path.join(logsDir, 'supervisor1-responses.txt');
...
// Main test cases
test.describe('All Supervisor1 Role Test Cases', () => {
  test('Supervisor1 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Supervisor 1";
    ...
    }, "Supervisor 1 Navigate to login page", rolePrefix);
