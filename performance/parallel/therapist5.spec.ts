...
const responseLogsFile = path.join(logsDir, 'therapist5-responses.txt');
...
// Main test cases
test.describe('All Therapist5 Role Test Cases', () => {
  test('Therapist5 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Therapist 5";
    ...
    }, "Therapist 5 Navigate to login page", rolePrefix);
