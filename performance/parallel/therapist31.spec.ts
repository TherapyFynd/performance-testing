...
const responseLogsFile = path.join(logsDir, 'therapist31-responses.txt');
...
// Main test cases
test.describe('All Therapist31 Role Test Cases', () => {
  test('Therapist31 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Therapist 31";
    ...
    }, "Therapist 31 Navigate to login page", rolePrefix);
    await page.getByPlaceholder('Enter last name').click();
    await page.getByPlaceholder('Enter last name').fill('31');
