...
const responseLogsFile = path.join(logsDir, 'therapist7-responses.txt');
...
// Main test cases
test.describe('All Therapist7 Role Test Cases', () => {
  test('Therapist7 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Therapist 7";
    ...
    }, "Therapist 7 Navigate to login page", rolePrefix);
    await page.getByPlaceholder('Enter last name').click();
    await page.getByPlaceholder('Enter last name').fill('7');
