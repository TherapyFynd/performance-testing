...
const responseLogsFile = path.join(logsDir, 'supervisor3-responses.txt');
...
// Main test cases
test.describe('All Supervisor3 Role Test Cases', () => {
  test('Supervisor3 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Supervisor 3";
    ...
    }, "Supervisor 3 Navigate to login page", rolePrefix);
