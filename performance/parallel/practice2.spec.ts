...
// Main test cases
test.describe('All Practice2 Role Test Cases', () => {
  test('Practice2 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Practice 2";
  ...
  }, "Practice 2 Navigate to login page", rolePrefix);
