...
const responseLogsFile = path.join(logsDir, 'therapist42-responses.txt');
...
// Main test cases
test.describe('All Therapist42 Role Test Cases', () => {
  test('Therapist42 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Therapist 42";
    ...
    }, "Therapist 42 Navigate to login page", rolePrefix);
    await page.getByPlaceholder('Enter last name').click();
    await page.getByPlaceholder('Enter last name').fill('42');
