...
const responseLogsFile = path.join(logsDir, 'therapist21-responses.txt');
...
// Main test cases
test.describe('All Therapist21 Role Test Cases', () => {
  test('Therapist21 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Therapist 21";
    ...
    }, "Therapist 21 Navigate to login page", rolePrefix);
