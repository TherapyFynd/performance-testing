...
const responseLogsFile = path.join(logsDir, 'therapist6-responses.txt');
...
// Main test cases
test.describe('All Therapist6 Role Test Cases', () => {
  test('Therapist6 login and onboarding', async ({ request }) => {
    const myEmails: IEmail = await readEmails();
    const rolePrefix = "Therapist 6";
    ...
    }, "Therapist 6 Navigate to login page", rolePrefix);
